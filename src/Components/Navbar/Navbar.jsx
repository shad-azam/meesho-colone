  ...
  return (
    <>
      ...
      <Nav>
        ...
        <div style={{ alignItems: 'center', textAlign: 'center', backgroundColor: '#3C3C3C'}} >
          <p style={{marginTop: '10px', marginBottom: '10px', alignItems: 'center', textAlign: 'center', color:'#fff'}}>This project is part of the Newton School SkillsBuild program</p>
        </div>
